...
if __name__ == '__main__':
    ...
    parser.add_argument('--branch', help='Banco do Brasil Branch number, in the format 00000', required=True)
    parser.add_argument('--account', help='Banco do Brasil Account number, in the format 000000', required=True)
